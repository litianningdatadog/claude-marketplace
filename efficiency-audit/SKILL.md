...
These four principles govern how this skill itself operates. They are derived from
...
**Flagging violations:** If the audit output or any generated content violates these four
rules (e.g. a proposed CLAUDE.md block that adds speculative rules, or a Phase 4 change that
touches more than was asked), call it out explicitly before proceeding: `[GUARDRAIL: ...]`.
